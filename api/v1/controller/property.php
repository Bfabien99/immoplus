...
if (empty($_GET)) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET') {
        ...
        try {
            ...
            $newProperty = new Property(null, $jsonData->title, $jsonData->description, $jsonData->type, $jsonData->address, $jsonData->area, $jsonData->price, $jsonData->shower, $jsonData->bedroom,$jsonData->picture,$jsonData->userId ?? null,$jsonData->raison ?? null);
